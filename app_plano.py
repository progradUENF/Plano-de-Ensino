...
Original file is located at
    https://colab.research.google.com/drive/1puxYbuCQojsttAgvHGLFieodm2XcnFRO
"""
...
def get_feriados_2026():
    ...
    feriados = [
        ...
        {"data": date(2026, 1, 20), "nome": "Dia de São Sebastião (RJ)"},
        # Feriados municipais (Campos dos Goytacazes - exemplo)
        {"data": date(2026, 3, 28), "nome": "Aniversário de Campos"},
        {"data": date(2026, 6, 24), "nome": "São João"},
...
with st.sidebar:
    ...
    with st.sidebar.expander("📅 Feriados 2026"):
        ...
        for mes_nome, dias in meses:
            for dia in dias:
                st.write(f"  • {dia:02d}/{mes_nome[:3]} - {mes_nome}")
    ...
    if os.path.exists("logo_prograd.png"):
        st.sidebar.markdown('<div class="logo-prograd-container">', unsafe_allow_html=True)
        st.sidebar.image("logo_prograd.png", use_container_width=True)
        st.sidebar.markdown('</div>', unsafe_allow_html=True)

    st.sidebar.markdown("<br>", unsafe_allow_html=True)

    if os.path.exists("logo_uenf.png"):
        st.sidebar.markdown('<div class="logo-uenf-container">', unsafe_allow_html=True)
        st.sidebar.image("logo_uenf.png", width=200)
        st.sidebar.markdown('</div>', unsafe_allow_html=True)
